...
@section('title')
{{$students[$student_index]['name']}}'s | Profile
@endsection
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="img-container">
                    <img src="{{$students[$student_index]['image']}}" alt="team member" class="img-full">
                </div>
            </div>
            <div class="col-lg-9 col-md-8">
                <div class="member_designation">
                    <h2>{{$students[$student_index]['name']}}</h2>
                </div>
                <div class="member_desc">
<h3>Projects</h3>
<ul class="styled_list">

@foreach($students[$student_index]['projects'] as $key => $value)
...
@endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="social-icons">
                                    ...
                                    <button class="btn btn-social outlined"><a href="{{$students[$student_index]['linkedin']}}"><i class="fa fa-linkedin"></i></a></button>
                ...
                <div class="member_desc">
                    ...
                    <p>
{{$students[$student_index]['name']}} is a student at orange coding academy and studies HTML/5, CSS/3, JavaScript, PHP/Laravel, MYSQL, MERN Stack, Python, React & React Native and other technologies he was born in {{$students[$student_index]['birthday']}}
                    </p>
